...
abstract class StreamFilterConvertLinefeedSpec
{
     ...
     *                                                     ]
     * @return StreamFilterConvertLinefeedSpecEntity スペックエンティティ
     */
     ...
     * @return StreamFilterConvertLinefeedSpecEntity 変換後の改行コード表現を設定したスペックエンティティ
     */
     ...
     * @return StreamFilterConvertLinefeedSpecEntity 変換前の改行コード表現を設定したスペックエンティティ
     */
     ...
     * @return StreamFilterConvertLinefeedSpecEntity Windows用の設定を行ったスペックエンティティ
     */
    public static function setupForWindows(string $from_linefeed = self::DEFAULT_FROM_LINEFEED): StreamFilterConvertLinefeedSpecEntity
    {
     ...
     *
     * @param  string                                $from_linefeed 変換前改行コード表現文字
     * @return StreamFilterConvertLinefeedSpecEntity Unix系用の設定を行ったスペックエンティティ
     */
    public static function setupForUnix(string $from_linefeed = self::DEFAULT_FROM_LINEFEED): StreamFilterConvertLinefeedSpecEntity
    {
